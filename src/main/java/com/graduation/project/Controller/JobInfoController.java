...
public class JobInfoController {
    ...
    public UnifiedShow getAllJobinfo(int page, int limit, String search) {
    ...
    public UnifiedShow getJobinfoById( Integer jobInfoId) {

        return new UnifiedShow().show( jobinfoMapper.selectByPrimaryKey(jobInfoId));
    }
